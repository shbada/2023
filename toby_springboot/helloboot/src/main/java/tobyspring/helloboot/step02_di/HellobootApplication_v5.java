...
//		new Tomcat().start(); // tomcat 서버를 띄울수있나? 아니다. 좀더 복잡하다.
		...
		applicationContext.registerBean(tobyspring.helloboot.step01_frontcontroller.HelloController.class); // 빈 등록
			...
			servletContext.addServlet("hello", new HttpServlet() {
				...
				protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
					...
					if (req.getRequestURI().equals("/hello") && req.getMethod().equals(HttpMethod.GET.name())) {
						...
						/** 빈 조회 */
						tobyspring.helloboot.step01_frontcontroller.HelloController helloController = applicationContext.getBean(HelloController.class);
